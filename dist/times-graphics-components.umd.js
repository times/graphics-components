...
`;function Ne({data:s}){return m.jsxs(m.Fragment,{children:[m.jsx(ce,{}),m.jsxs(Oe,{children:[m.jsxs("div",{className:"card-image--container",children:[m.jsx("img",{src:`https://extras.thetimes.co.uk/web/2025/times-knife-crime-audio/assets/${s.imgSrc}.jpg`,className:"card-image"}),m.jsx("p",{className:"card-name",children:s.name})]}),m.jsx("p",{className:"card-quote",children:s.quote}),m.jsx(le,{height:100,waveColor:"#ff0000",progressColor:"#940000",url:`https://extras.thetimes.co.uk/web/2025/times-knife-crime-audio/assets/${s.audioSrc}.m4a`,normalize:!0,barWidth:2,barGap:2,barRadius:2,cursorWidth:2},s.id)]})]})}var J={},Z={},ue;function Ae(){return ue||(ue=1,function(s){Object.defineProperty(s,"__esModule",{value:!0}),s.default=void 0;var e;function t(r,n,a){return n in r?Object.defineProperty(r,n,{value:a,enumerable:!0,configurable:!0,writable:!0}):r[n]=a,r}var i={digital:(e={blue:{r:37,g:66,b:81},yellow:{r:224,g:171,b:38},lightBlue:{r:224,g:171,b:38}},t(e,"yellow",{r:128,g:177,b:226}),t(e,"orange",{r:243,g:127,b:47}),t(e,"teal",{r:50,g:146,b:166}),t(e,"purple",{r:108,g:60,b:94}),t(e,"sand",{r:218,g:207,b:193}),e),ukPoliticalParties:{con:{r:64,g:147,b:178},lab:{r:236,g:81,b:86},libdem:{r:246,g:197,b:94},ukip:{r:151,g:103,b:174},snp:{r:255,g:246,b:133},green:{r:97,g:169,b:97},pc:{r:144,g:205,b:124},dup:{r:161,g:82,b:82},sf:{r:68,g:150,b:107},sdlp:{r:125,g:161,b:125},uup:{r:63,g:97,b:124},others:{r:160,g:147,b:143}}};s.default=i}(Z)),Z}var Q={},he;function De(){return he||(he=1,function(s){Object.defineProperty(s,"__esModule",{value:!0}),s.default=void 0;var e={micro:"400px",small:"520px",mobile:"768px",tablet:"1024px",desktop:"1200px","desktop-wide":"1320px"};s.default=e}(Q)),Q}var pe;function Le(){return pe||(pe=1,function(s){Object.defineProperty(s,"__esModule",{value:!0}),Object.defineProperty(s,"colors",{enumerable:!0,get:function(){return e.default}}),Object.defineProperty(s,"breakpoints",{enumerable:!0,get:function(){return t.default}});var e=i(Ae()),t=i(De());function i(r){return r&&r.__esModule?r:{default:r}}}(J)),J}Le();const We=N.div`
    .headline {
        font-family: 'RobotoRegular', sans-serif;
        font-size: 20px;
        font-weight: 700;
...
`;function me({headline:s,standfirst:e}){return m.jsxs(We,{children:[s&&m.jsx("h1",{className:"headline",children:s}),e&&m.jsx("p",{className:"standfirst",children:e})]})}const ze=N.div`
    margin-block: 1em;
    margin-inline: 10px;
...
`;function fe({data:s,clickedImage:e,setClickedImage:t,setShowTooltip:i,setTooltipPos:r}){function n(l,u){t(u),i(!0),r([l.clientX,l.target.offsetTop+l.target.offsetHeight-20])}const a=s.map(l=>m.jsx(Ie,{src:`https://nuk-tnl-editorial-prod-staticassets.s3.amazonaws.com/2024/times-image-grid/assets/${l.imgSrc}.jpg`,alt:l.name,grayscale:!1,lazy:!0,onClick:u=>n(u,l),isHovered:e===l},l.id));return m.jsx(ze,{children:a})}const Be=N.div`
    position: absolute;
    left: 0px;
...
`,Ue=N.p`
    ...
    font-size: 18px;
    line-height: 30px;
`;function Xe({data:s}){const{slides:e=[],imgFit:t="cover",containerWidth:i="edge-to-edge",borderRadius:r="0",fixedImgHeight:n,fontSize:a="md",videoLoop:l=!0,videoAutoplay:u=!0,videoControls:h=!1,videoMute:c=!0}=s,[f,p]=C.useState(0),[b,x]=C.useState([]),T=C.useRef([]),w=C.useRef([]);C.useEffect(()=>{const d=new IntersectionObserver(g=>{g.forEach(E=>{if(E.isIntersecting){const A=parseInt(E.target.dataset.index,10);p(A)}})},{threshold:.6});return T.current.forEach(g=>g&&d.observe(g)),()=>d.disconnect()},[e.length]),C.useEffect(()=>{const d=e.map((g,E)=>E===f);x(d)},[f,e]);const k=d=>b[d]?2:1,S=d=>{var g;if(d.includes("youtube.com")){const E=(g=d.split("v=")[1])==null?void 0:g.split("&")[0];return`https://www.youtube.com/embed/${E}?autoplay=${u?1:0}&loop=${l?1:0}&controls=${h?1:0}&mute=${c?1:0}&playlist=${E}`}else if(d.includes("vimeo.com"))return`https://player.vimeo.com/video/${d.split("/").pop()}?autoplay=${u?1:0}&loop=${l?1:0}&controls=${h?1:0}&muted=${c?1:0}`;return d},_=d=>d.includes("youtube.com")||d.includes("youtu.be"),y=d=>d.endsWith(".mp4");return m.jsxs(de,{children:[m.jsx(Ye,{style:{height:n||"500px"},className:i==="edge-to-edge"?"edge-to-edge":i==="bleed"?"bleed":"",children:m.jsx(He,{children:e.map((d,g)=>m.jsx(Ge,{ref:E=>w.current[g]=E,className:b[g]?"overlap":"",style:{zIndex:k(g)},children:_(d.media)?m.jsx("iframe",{title:"YouTube video",src:S(d.media),frameBorder:"0",allow:"autoplay; encrypted-media",allowFullScreen:!0,style:{objectFit:t,width:"100%",height:n||(i==="edge-to-edge"?"100vh":"100%"),borderRadius:r}}):y(d.media)?m.jsx("video",{autoPlay:u,loop:l,controls:h,muted:c,style:{objectFit:t,width:"100%",height:n||"100%",borderRadius:r},children:m.jsx("source",{src:d.media,type:"video/mp4"})}):m.jsx("img",{src:d.media,alt:d.altText||"Slide image",style:{objectFit:t,width:"100%",height:n||"100%",borderRadius:r}})},g))})}),m.jsx("div",{className:"scroller-sections",children:e.map((d,g)=>m.jsx(Ve,{className:"trigger","data-index":g,ref:E=>T.current[g]=E,children:d.text&&m.jsx(Ue,{size:a,dangerouslySetInnerHTML:{__html:d.text}})},g))})]})}O.AudioPlayer=Ne,O.Equalizer=le,O.Grid=fe,O.Header=me,O.ImageGrid=Fe,O.ScrollStory=Xe,O.Tooltip=ge,Object.defineProperty(O,Symbol.toStringTag,{value:"Module"})});
