...
`;function me({headline:s,standfirst:e}){return c.jsxs(We,{children:[s&&c.jsx("h1",{className:"headline",children:s}),e&&c.jsx("p",{className:"standfirst",children:e})]})}const ze=R.div`
    margin-block: 1em;
    margin-inline: 10px;
...
`;function fe({data:s,clickedImage:e,setClickedImage:t,setShowTooltip:i,setTooltipPos:r}){function n(l,u){t(u),i(!0),r([l.clientX,l.target.offsetTop+l.target.offsetHeight-20])}const o=s.map(l=>c.jsx(Ie,{src:`https://nuk-tnl-editorial-prod-staticassets.s3.amazonaws.com/2024/times-image-grid/assets/${l.imgSrc}.jpg`,alt:l.name,grayscale:!1,lazy:!0,onClick:u=>n(u,l),isHovered:e===l},l.id));return c.jsx(ze,{children:o})}const Be=R.div`
    position: absolute;
    left: 0px;
...
`;function ge({clickedImage:s,setClickedImage:e,tooltipPos:t,showTooltip:i,setShowTooltip:r,isImageInLastRow:n}){if(!s)return;function o(){r(!1),e(null)}return c.jsxs(Be,{showTooltip:i,tooltipPos:t,isImageInLastRow:n,children:[c.jsx("img",{className:"tooltip-image",src:`https://nuk-tnl-editorial-prod-staticassets.s3.amazonaws.com/2024/times-image-grid/assets/${s.imgSrc}.jpg`,alt:s.name}),c.jsxs("div",{className:"tooltip-content",children:[c.jsx("h3",{children:s.name}),c.jsx("p",{children:s.copy})]}),c.jsx("button",{className:"tooltip-close",onClick:o,children:c.jsx("img",{src:"https://nuk-tnl-editorial-prod-staticassets.s3.amazonaws.com/2023/st-grid-jeremy-clarkson/assets/x.svg"})})]})}function Fe({data:s}){const[e,t]=C.useState(null),[i,r]=C.useState(!1),[n,o]=C.useState([0,0]);let u=s.length-s.indexOf(e)<=7;return c.jsxs(c.Fragment,{children:[c.jsx(q,{}),c.jsxs(de,{children:[c.jsx(me,{headline:"Lorem ipsum dolor sit amet",standfirst:"Nulla vel augue ut erat efficitur scelerisque id vel tellus. Ut iaculis nulla sit amet lorem rutrum, ac luctus sem imperdiet"}),c.jsx(fe,{data:s,clickedImage:e,setClickedImage:t,setShowTooltip:r,setTooltipPos:o}),c.jsx(ge,{clickedImage:e,setClickedImage:t,showTooltip:i,setShowTooltip:r,tooltipPos:n,isImageInLastRow:u})]})]})}R.div`
    position: relative;
    width: 100%;
`;const $e=R.div`
    position: sticky;
...
`,qe=({data:s={},children:e})=>{const{hed:t="",dek:i="",chartTitle:r="",note:n="",source:o=""}=s;return c.jsxs(Xe,{children:[t&&c.jsx("h3",{children:t}),i&&c.jsx("h4",{children:i}),r&&c.jsx("p",{className:"chart-title",children:r}),e,(n||o)&&c.jsxs("div",{className:"note-container",children:[n&&c.jsx("p",{className:"note",children:n}),o&&c.jsx("p",{className:"note",children:o})]})]})},Je=R.div`
    display: block;
    margin: 20px auto;
    position: relative;
...
`,et=(s,e,t,i,r)=>{var n;if(s.includes("youtube.com")){const o=(n=s.split("v=")[1])==null?void 0:n.split("&")[0];return`https://www.youtube.com/embed/${o}?autoplay=${e?1:0}&loop=${t?1:0}&controls=${i?1:0}&mute=${r?1:0}&playlist=${o}`}else if(s.includes("vimeo.com"))return`https://player.vimeo.com/video/${s.split("/").pop()}?autoplay=${e?1:0}&loop=${t?1:0}&controls=${i?1:0}&muted=${r?1:0}`;return s},tt=({data:s})=>{if(!s)return null;const{fixedImgHeight:e=null,containerWidth:t="inline",imgBorderRadius:i=null,media:r="",videoLoop:n="true",videoAutoplay:o="true",videoControls:l="false",videoMute:u="true",text:h,caption:d,altText:f}=s,w=et(r,o===!0,n===!0,l===!0,u===!0),k=c.jsxs(Ke,{$containerWidth:t,$fixedImgHeight:e,$imgBorderRadius:i,children:[r.includes("youtube.com")||r.includes("vimeo.com")?c.jsx("iframe",{src:w,title:"Embedded media",allow:"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture",allowFullScreen:!0}):r.endsWith(".mp4")?c.jsxs("video",{autoPlay:o,loop:n,controls:l,muted:u,children:[c.jsx("source",{src:r,type:"video/mp4"}),c.jsx("track",{kind:"captions",src:r.replace(".mp4",".vtt"),label:"English"}),"Your browser does not support the video tag."]}):c.jsx("img",{src:r,alt:f}),h&&c.jsx(Ze,{$imgBorderRadius:i,dangerouslySetInnerHTML:{__html:h}}),d&&c.jsx(Qe,{$imgBorderRadius:i,dangerouslySetInnerHTML:{__html:d}})]});return c.jsxs(c.Fragment,{children:[c.jsx(q,{}),c.jsx(Je,{className:t,children:c.jsx(qe,{data:s,children:k})})]})};O.AudioPlayer=Ne,O.Equalizer=ce,O.Grid=fe,O.Header=me,O.ImageGrid=Fe,O.MediaBlock=tt,O.ScrollStory=Ue,O.Tooltip=ge,Object.defineProperty(O,Symbol.toStringTag,{value:"Module"})});
