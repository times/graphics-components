...
`,U=C.memo(n=>{const e=C.useRef(null),[t,i]=C.useState(!1),[s,r]=C.useState(.5),[o,a]=C.useState(0),[c,h]=C.useState(x(0)),[l,m]=C.useState(!1),u=re(e,n),f=C.useRef(null),{onPlay:v,onReady:S}=n,y=C.useCallback(()=>{u.playPause()},[u]);C.useEffect(()=>{if(!u)return;u.setVolume(s);const b=()=>({media:u.getMediaElement(),peaks:u.exportPeaks()}),d=[u.on("ready",()=>{S&&S(b()),a(x(Math.round(u.getDuration()*1e3))),i(u.isPlaying())}),u.on("play",()=>{v&&v(g=>{const w=b();return!g||g.media!==w.media?(g&&(g.media.pause(),g.media.currentTime=0),w):g}),i(!0)}),u.on("audioprocess",()=>{h(x(Math.round(u.getCurrentTime()*1e3)))}),u.on("pause",()=>i(!1))];return()=>{d.forEach(g=>g())}},[u,v,S,s]),C.useEffect(()=>{const b=f.current;b.style.setProperty("--value",b.value),b.style.setProperty("--min",b.min===""?"0":b.min),b.style.setProperty("--max",b.max===""?"100":b.max),b.style.setProperty("--value",b.value)},[]);function x(b){var d=Math.floor(b/6e4),g=(b%6e4/1e3).toFixed(0);return d+":"+(g<10?"0":"")+g}function k(b){r(b.target.value);const d=b.target;d.style.setProperty("--value",d.value),d.style.setProperty("--min",d.min===""?"0":d.min),d.style.setProperty("--max",d.max===""?"100":d.max),d.style.setProperty("--value",d.value)}function E(){m(!l)}return p.jsxs(ne,{children:[t?p.jsx("img",{className:"play-icon",src:"https://extras.thetimes.co.uk/web/2025/times-knife-crime-audio/assets/pause.png",onClick:y}):p.jsx("img",{className:"play-icon",src:"https://extras.thetimes.co.uk/web/2025/times-knife-crime-audio/assets/play.png",onClick:y}),p.jsx("div",{ref:e,style:{width:"100%"}}),p.jsxs("p",{className:"waveform-time",children:[p.jsx("span",{children:c})," / ",p.jsx("span",{children:o})]}),p.jsxs("div",{className:"volume-container",children:[p.jsx("img",{className:"volume-icon",src:"https://extras.thetimes.co.uk/web/2025/times-knife-crime-audio/assets/volume.png",onClick:E}),p.jsx("input",{ref:f,className:"styled-slider slider-progress",type:"range",id:"volume-slider",min:0,max:1,step:.1,value:s,onChange:k,style:{opacity:l?1:0,pointerEvents:l?"all":"none"}})]})]})});U.__docgenInfo={description:"",methods:[],displayName:"Equalizer"};function oe({data:n}){return p.jsxs(p.Fragment,{children:[p.jsx(z,{}),p.jsxs(K,{children:[p.jsxs("div",{className:"card-image--container",children:[p.jsx("img",{src:`https://extras.thetimes.co.uk/web/2025/times-knife-crime-audio/assets/${n.imgSrc}.jpg`,className:"card-image"}),p.jsx("p",{className:"card-name",children:n.name})]}),p.jsx("p",{className:"card-quote",children:n.quote}),p.jsx(U,{height:100,waveColor:"#ff0000",progressColor:"#940000",url:`https://extras.thetimes.co.uk/web/2025/times-knife-crime-audio/assets/${n.audioSrc}.m4a`,normalize:!0,barWidth:2,barGap:2,barRadius:2,cursorWidth:2},n.id)]})]})}oe.__docgenInfo={description:"",methods:[],displayName:"AudioPlayer"};var W={},A={},q;function ae(){return q||(q=1,function(n){Object.defineProperty(n,"__esModule",{value:!0}),n.default=void 0;var e;function t(s,r,o){return r in s?Object.defineProperty(s,r,{value:o,enumerable:!0,configurable:!0,writable:!0}):s[r]=o,s}var i={digital:(e={blue:{r:37,g:66,b:81},yellow:{r:224,g:171,b:38},lightBlue:{r:224,g:171,b:38}},t(e,"yellow",{r:128,g:177,b:226}),t(e,"orange",{r:243,g:127,b:47}),t(e,"teal",{r:50,g:146,b:166}),t(e,"purple",{r:108,g:60,b:94}),t(e,"sand",{r:218,g:207,b:193}),e),ukPoliticalParties:{con:{r:64,g:147,b:178},lab:{r:236,g:81,b:86},libdem:{r:246,g:197,b:94},ukip:{r:151,g:103,b:174},snp:{r:255,g:246,b:133},green:{r:97,g:169,b:97},pc:{r:144,g:205,b:124},dup:{r:161,g:82,b:82},sf:{r:68,g:150,b:107},sdlp:{r:125,g:161,b:125},uup:{r:63,g:97,b:124},others:{r:160,g:147,b:143}}};n.default=i}(A)),A}var $={},F;function le(){return F||(F=1,function(n){Object.defineProperty(n,"__esModule",{value:!0}),n.default=void 0;var e={micro:"400px",small:"520px",mobile:"768px",tablet:"1024px",desktop:"1200px","desktop-wide":"1320px"};n.default=e}($)),$}var G;function de(){return G||(G=1,function(n){Object.defineProperty(n,"__esModule",{value:!0}),Object.defineProperty(n,"colors",{enumerable:!0,get:function(){return e.default}}),Object.defineProperty(n,"breakpoints",{enumerable:!0,get:function(){return t.default}});var e=i(ae()),t=i(le());function i(s){return s&&s.__esModule?s:{default:s}}}(W)),W}de();const ce=M.div`
    .headline {
...
`,ye=M.p`
    ...
    font-size: 18px;
    line-height: 30px;
`;function xe({data:n}){const{slides:e=[],imgFit:t="cover",containerWidth:i="edge-to-edge",borderRadius:s="0",fixedImgHeight:r,fontSize:o="md",videoLoop:a=!0,videoAutoplay:c=!0,videoControls:h=!1,videoMute:l=!0}=n,[m,u]=C.useState(0),[f,v]=C.useState([]),S=C.useRef([]),y=C.useRef([]);C.useEffect(()=>{const d=new IntersectionObserver(g=>{g.forEach(w=>{if(w.isIntersecting){const T=parseInt(w.target.dataset.index,10);u(T)}})},{threshold:.6});return S.current.forEach(g=>g&&d.observe(g)),()=>d.disconnect()},[e.length]),C.useEffect(()=>{const d=e.map((g,w)=>w===m);v(d)},[m,e]);const x=d=>f[d]?2:1,k=d=>{var g;if(d.includes("youtube.com")){const w=(g=d.split("v=")[1])==null?void 0:g.split("&")[0];return`https://www.youtube.com/embed/${w}?autoplay=${c?1:0}&loop=${a?1:0}&controls=${h?1:0}&mute=${l?1:0}&playlist=${w}`}else if(d.includes("vimeo.com"))return`https://player.vimeo.com/video/${d.split("/").pop()}?autoplay=${c?1:0}&loop=${a?1:0}&controls=${h?1:0}&muted=${l?1:0}`;return d},E=d=>d.includes("youtube.com")||d.includes("youtu.be"),b=d=>d.endsWith(".mp4");return p.jsxs(p.Fragment,{children:[p.jsx(z,{}),p.jsxs(V,{children:[p.jsx(ge,{style:{height:r||"500px"},className:i==="edge-to-edge"?"edge-to-edge":i==="bleed"?"bleed":"",children:p.jsx(fe,{children:e.map((d,g)=>p.jsx(be,{ref:w=>y.current[g]=w,className:f[g]?"overlap":"",style:{zIndex:x(g)},children:E(d.media)?p.jsx("iframe",{title:"YouTube video",src:k(d.media),frameBorder:"0",allow:"autoplay; encrypted-media",allowFullScreen:!0,style:{objectFit:t,width:"100%",height:r||(i==="edge-to-edge"?"100vh":"100%"),borderRadius:s}}):b(d.media)?p.jsx("video",{autoPlay:c,loop:a,controls:h,muted:l,style:{objectFit:t,width:"100%",height:r||"100%",borderRadius:s},children:p.jsx("source",{src:d.media,type:"video/mp4"})}):p.jsx("img",{src:d.media,alt:d.altText||"Slide image",style:{objectFit:t,width:"100%",height:r||"100%",borderRadius:s}})},g))})}),p.jsx("div",{className:"scroller-sections",children:e.map((d,g)=>p.jsx(ve,{className:"trigger","data-index":g,ref:w=>S.current[g]=w,children:d.text&&p.jsx(ye,{size:o,dangerouslySetInnerHTML:{__html:d.text}})},g))})]})]})}xe.__docgenInfo={description:"",methods:[],displayName:"ScrollStory"};export{oe as A,me as I,xe as S};
