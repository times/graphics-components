...
`,h=({text:t,align:r="left"})=>t?e.jsxs(e.Fragment,{children:[e.jsx(d,{}),e.jsx(k,{align:r,children:t})]}):null;h.__docgenInfo={description:"",methods:[],displayName:"Headline",props:{align:{defaultValue:{value:"'left'",computed:!1},required:!1}}};const z=s.p`
    ...
    overflow-wrap: break-word;
    text-align: ${({align:t})=>t||"left"};
`,b=({text:t,align:r="left"})=>t?e.jsxs(e.Fragment,{children:[e.jsx(d,{}),e.jsx(z,{align:r,children:t})]}):null;b.__docgenInfo={description:"",methods:[],displayName:"Description",props:{align:{defaultValue:{value:"'left'",computed:!1},required:!1}}};const F=s.p`
    font-family: TimesModern-Regular, TimesModern-Regular-fallback, serif;
    font-size: 20px;
    line-height: 26px;
    color: rgb(51, 51, 51);
