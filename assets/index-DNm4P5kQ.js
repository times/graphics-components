...
`;function ar({headline:t,standfirst:e}){return m.jsxs(ji,{children:[t&&m.jsx("h1",{className:"headline",children:t}),e&&m.jsx("p",{className:"standfirst",children:e})]})}ar.__docgenInfo={description:"",methods:[],displayName:"Header"};const Ti=_.div`
    margin-block: 1em;
    margin-inline: 10px;
...
`;function lr({clickedImage:t,setClickedImage:e,tooltipPos:r,showTooltip:i,setShowTooltip:n,isImageInLastRow:s}){if(!t)return;function o(){n(!1),e(null)}return m.jsxs(Ni,{showTooltip:i,tooltipPos:r,isImageInLastRow:s,children:[m.jsx("img",{className:"tooltip-image",src:`https://nuk-tnl-editorial-prod-staticassets.s3.amazonaws.com/2024/times-image-grid/assets/${t.imgSrc}.jpg`,alt:t.name}),m.jsxs("div",{className:"tooltip-content",children:[m.jsx("h3",{children:t.name}),m.jsx("p",{children:t.copy})]}),m.jsx("button",{className:"tooltip-close",onClick:o,children:m.jsx("img",{src:"https://nuk-tnl-editorial-prod-staticassets.s3.amazonaws.com/2023/st-grid-jeremy-clarkson/assets/x.svg"})})]})}lr.__docgenInfo={description:"",methods:[],displayName:"Tooltip"};function Mi({data:t}){const[e,r]=j.useState(null),[i,n]=j.useState(!1),[s,o]=j.useState([0,0]);let c=t.length-t.indexOf(e)<=7;return m.jsxs(m.Fragment,{children:[m.jsx(Be,{}),m.jsxs(or,{children:[m.jsx(ar,{headline:"Lorem ipsum dolor sit amet",standfirst:"Nulla vel augue ut erat efficitur scelerisque id vel tellus. Ut iaculis nulla sit amet lorem rutrum, ac luctus sem imperdiet"}),m.jsx(cr,{data:t,clickedImage:e,setClickedImage:r,setShowTooltip:n,setTooltipPos:o}),m.jsx(lr,{clickedImage:e,setClickedImage:r,showTooltip:i,setShowTooltip:n,tooltipPos:s,isImageInLastRow:c})]})]})}Mi.__docgenInfo={description:"",methods:[],displayName:"ImageGrid"};_.div`
    position: relative;
    width: 100%;
`;const Ii=_.div`
    position: sticky;
