...
`;function lr({clickedImage:t,setClickedImage:e,tooltipPos:r,showTooltip:i,setShowTooltip:n,isImageInLastRow:s}){if(!t)return;function o(){n(!1),e(null)}return m.jsxs(Mi,{showTooltip:i,tooltipPos:r,isImageInLastRow:s,children:[m.jsx("img",{className:"tooltip-image",src:`https://nuk-tnl-editorial-prod-staticassets.s3.amazonaws.com/2024/times-image-grid/assets/${t.imgSrc}.jpg`,alt:t.name}),m.jsxs("div",{className:"tooltip-content",children:[m.jsx("h3",{children:t.name}),m.jsx("p",{children:t.copy})]}),m.jsx("button",{className:"tooltip-close",onClick:o,children:m.jsx("img",{src:"https://nuk-tnl-editorial-prod-staticassets.s3.amazonaws.com/2023/st-grid-jeremy-clarkson/assets/x.svg"})})]})}lr.__docgenInfo={description:"",methods:[],displayName:"Tooltip"};function Ni({data:t}){const[e,r]=T.useState(null),[i,n]=T.useState(!1),[s,o]=T.useState([0,0]);let c=t.length-t.indexOf(e)<=7;return m.jsxs(m.Fragment,{children:[m.jsx(pt,{}),m.jsxs(or,{children:[m.jsx(ar,{headline:"Lorem ipsum dolor sit amet",standfirst:"Nulla vel augue ut erat efficitur scelerisque id vel tellus. Ut iaculis nulla sit amet lorem rutrum, ac luctus sem imperdiet"}),m.jsx(cr,{data:t,clickedImage:e,setClickedImage:r,setShowTooltip:n,setTooltipPos:o}),m.jsx(lr,{clickedImage:e,setClickedImage:r,showTooltip:i,setShowTooltip:n,tooltipPos:s,isImageInLastRow:c})]})]})}Ni.__docgenInfo={description:"",methods:[],displayName:"ImageGrid"};_.div`
    position: relative;
    width: 100%;
`;const Ii=_.div`
    position: sticky;
